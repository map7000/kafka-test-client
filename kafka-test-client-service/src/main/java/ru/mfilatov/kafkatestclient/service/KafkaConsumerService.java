...
/**
 * Service for consuming and processing Kafka messages.
 * Provides message handling with retry capability and metrics.
 */
@Slf4j
@Component
...
public class KafkaConsumerService {
     ...
     * Implements retry logic and tracks metrics.
     *
    ...
    public void listen(
        ...
        try {
            ...
            int roll = rollTheDiceService.rollDice();
