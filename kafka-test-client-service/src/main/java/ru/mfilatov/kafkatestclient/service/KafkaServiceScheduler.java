...
/**
 * Schedules and manages delayed Kafka message deliveries.
 * Uses concurrent data structures for thread-safe operation.
 */
@Slf4j
@Component
...
public class KafkaServiceScheduler {
    ...
    private static final long PROCESSING_INTERVAL_MS = 250;
    ...
    /**
     * Processes messages that are due for delivery.
     * Runs every 250ms by default.
     */
    ...
    /**
     * Cleans up old messages from the queue.
    ...
    public void scheduleMessage(String value, String rqUid, long delaySeconds) {
        ...
        var message = new KafkaMessageOnWait(
            value,
            rqUid,
